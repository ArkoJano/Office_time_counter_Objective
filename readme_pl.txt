...
W folderze glownym znajduja sie:
	...
	- build, 
	__pycache__  - pliki stworzone podczas tworzenia
		   		pliku wykonywalnego
...
Skrypt Python (wymaga zainstalowanego Pythona3 - testowane dla wersji 3.8.7)

	 - source/swi.py - wymaga uruchomienia w linii komend
